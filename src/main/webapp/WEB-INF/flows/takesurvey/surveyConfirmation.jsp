				...
				<div
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6 text-right">
							<p>
								<em> <fmt:formatDate type="date"
										value="${survey.addedDate}" /></em>
							</p>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<button id="back" class="btn btn-default"
							name="_eventId_backToCollectSurveyDetail">back</button>

						<button type="submit" class="btn btn-success"
							name="_eventId_surveyConfirmed">
