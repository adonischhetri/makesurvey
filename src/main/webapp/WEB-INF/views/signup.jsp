	...
	<!-- modelAttribute="newSignup" -->
		<form:form  class="form-horizontal" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="activeDate"><spring:message
							code="addProduct.form.activeDate.label" /></label>
					<div class="col-lg-10">
						<form:input id="activeDate" path="activeDate" type="text"
							class="form:input-large" />
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="profileImage">
